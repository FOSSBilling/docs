...
FOSSBilling is integrated with CWP (Control-WebPanel) using it's API. We will briefly describe how to setup the CWP API, however if needed you can view the [CWP API documentation](https://docs.control-webpanel.com/docs/developer-tools/api-manager/configuration).
