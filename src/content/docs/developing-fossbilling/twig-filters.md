...
FOSSBilling utilizes the popular Twig templating engine for various purposes (front-end, email templates, PDFs, etc.).
...
FOSSBilling includes all the default Twig filters, plus the following additional filters through extensions:

- The [Intl Extra Extension](https://github.com/twigphp/intl-extra) & associated filters

## By FOSSBilling

FOSSBilling has quite a few custom filters included in it. These filters come from [`/library/Box/TwigExtensions.php`](https://github.com/FOSSBilling/FOSSBilling/blob/main/src/library/Box/TwigExtensions.php).

Here's a complete list, with more detailed documentation to come:
...
- `iplookup`: Returns a clickable admin panel link to lookup the provided IP.