...
If you're developing a module or theme, avoid making direct API calls. Use the [JavaScript wrapper](/docs/developing-fossbilling/javascript) instead, which provides a streamlined way to communicate with the backend.
...
If you're new to API development or need help getting started, join our [Discord](https://fossbilling.org/discord) community. Happy coding!