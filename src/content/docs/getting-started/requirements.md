...
- LiteSpeed
- NGINX running the correct [configuration](/docs/getting-started/installation/#webserver-configurations).
- OpenLiteSpeed
...
FOSSBilling 0.7.x, which is the current stable release, supports PHP 8.2 - 8.4.
