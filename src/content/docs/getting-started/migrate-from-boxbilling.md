...
We suggest reviewing the [documented system requirements](/docs/getting-started/requirements).
...
- Quite a lot of work has gone into the Huraga theme, we suggest taking a look at its settings after migrating.
